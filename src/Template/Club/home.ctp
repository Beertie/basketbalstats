            ...
            <div class="card__content">
                ...
                <div class="table-responsive">
                    <table class="table table-hover team-result">
                        <thead>
                        <tr>
                            <th class="team-result__date">Club</th>
                            <th class="team-result__date">Teams</th>
                            <th class="team-result__date">Location</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                        foreach ($clubs as $club) {
                            ...
                            <tr>
                                ...
                                <td class="team-result__date"><a
                                            href="/club/index/<?= $club['id'] ?>"><?= $club['name'] ?>  </a></td>
                                <td class="team-result__date"><?= $club['amountOfTeams'] ?></td>
                                <td class="team-result__date"><?= $club['location'] ?></td>
            ...
            <div class="post-grid__item col-sm-6">
                <div class="posts__item posts__item--card posts__item--category-1 card">
                    ...
                    <div class="posts__inner card__content">
                        ...
                        <h6 class="posts__title"><a href="#">Michael Bryan was chosen again as best player with 45
                                points</a></h6>
                        <div class="posts__excerpt">
                            Lorem ipsum dolor sit amet, consectetur adipisi nel elit, sed do eiusmod tempor incididunt
                            ut labore et dolore magna aliqua. Ut enim ad mini veniam, quis nostrud en derum sum laborem.
                        </div>
                    </div>
            ...
            <div class="post-grid__item col-sm-6">
                <div class="posts__item posts__item--card posts__item--category-1 card">
                    ...
                    <div class="posts__inner card__content">
                        <a href="#" class="posts__cta"></a>
                        <time datetime="2016-08-23" class="posts__date">August 23rd, 2016</time>
                        <h6 class="posts__title"><a href="#">The new eco friendly stadium won a Leafy Award in 2016</a>
                        </h6>
                        <div class="posts__excerpt">
                            Lorem ipsum dolor sit amet, consectetur adipisi nel elit, sed do eiusmod tempor incididunt
                            ut labore et dolore magna aliqua. Ut enim ad mini veniam, quis nostrud en derum sum laborem.
                ...
                <div class="posts posts--simple-list posts--simple-list--xlg">
                    <div class="posts__item posts__item--category-1">
                        <div class="posts__inner">
                            ...
                            <h6 class="posts__title"><a href="#">Take a look at the brand <span class="text-primary">New Uniforms</span>
                                    for next season</a></h6>
                            ...
                            <div class="posts__more">
                                <a href="#" class="btn btn-inverse btn-sm btn-outline btn-icon-right btn-condensed">Read
                                    More <i class="fa fa-plus text-primary"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="posts__item posts__item--card posts__item--category-1 card">
                            ...
                            <div class="posts__inner">
                                <div class="card__content">
                                    ...
                                    <h6 class="posts__title"><a href="#">The team is taking a summer vacation on Woody
                                            Valley</a></h6>
                                    <time datetime="2016-08-17" class="posts__date">August 17th, 2016</time>
                                    <div class="posts__excerpt">
                                        Lorem ipsum dolor sit amet, consectetur adipisi nel elit, sed do eiusmod tempor
                        ...
                        <div class="posts__item posts__item--card posts__item--category-1 card">
                            ...
                            <div class="posts__inner">
                                <div class="card__content">
                                    ...
                                    <h6 class="posts__title"><a href="#">Jeremy Rittersen was called to be in the
                                            National Team</a></h6>
                        ...
                        <div class="posts__item posts__item--card posts__item--category-1 card">
                            ...
                            <div class="posts__inner">
                                <div class="card__content">
                                    ...
                                    <h6 class="posts__title"><a href="#">Alchemists New Stadium is gonna be ready in
                                            September 2017</a></h6>
                        ...
                        <div class="posts__item posts__item--card posts__item--category-1 card">
                            ...
                            <div class="posts__inner">
                                <div class="card__content">
                                    ...
                                    <h6 class="posts__title"><a href="#">The Championship Final will be be played in San
                                            Francisco</a></h6>
        ...
        <aside class="widget widget--sidebar widget-social">
            ...
            <a href="#" class="btn-social-counter btn-social-counter--twitter" target="_blank">
                ...
                <span class="btn-social-counter__count"><span
                            class="btn-social-counter__count-num"></span> Followers</span>
                <span class="btn-social-counter__add-icon"></span>
            </a>
                ...
                <ul class="posts posts--simple-list">
                    <li class="posts__item posts__item--category-2">
                        ...
                        <div class="posts__inner">
                            ...
                            <h6 class="posts__title"><a href="#">Mark Johnson has a Tibia Fracture and is gonna be
                                    out</a></h6>
                            <time datetime="2016-08-23" class="posts__date">August 23rd, 2016</time>
                        </div>
                    </li>
                    <li class="posts__item posts__item--category-1">
                        ...
                        <div class="posts__inner">
                            ...
                            <h6 class="posts__title"><a href="#">Jay Rorks is only 24 points away from breaking the
                                    record</a></h6>
                    ...
                    <li class="posts__item posts__item--category-1">
                        ...
                        <div class="posts__inner">
                            ...
                            <h6 class="posts__title"><a href="#">The new eco friendly stadium won a Leafy Award in
                                    2016</a></h6>
                    ...
                    <li class="posts__item posts__item--category-1">
                        ...
                        <div class="posts__inner">
                            ...
                            <h6 class="posts__title"><a href="#">The team is starting a new power breakfast regimen</a>
                            </h6>
                            <time datetime="2016-08-21" class="posts__date">August 21st, 2016</time>
                        </div>
                    </li>
                ...
                <div class="widget-game-result__section">
                    <div class="widget-game-result__section-inner">
                        <header class="widget-game-result__header">
                            ...
                            <time class="widget-game-result__date" datetime="2016-03-24">Saturday, March 24th, 2016
                            </time>
                        </header>
                        ...
                        <div class="widget-game-result__main">
                            ...
                            <div class="widget-game-result__team widget-game-result__team--second">
                                <figure class="widget-game-result__team-logo">
                                    <a href="#"><img
                                                src="assets/images/samples/logos/sharks_last_game_results_small.png"
                                                alt=""></a>
                                </figure>
                                <div class="widget-game-result__team-info">
            ...
            <div class="widget__content card__content">
                <div class="widget-tabbed__tabs">
                    ...
                    <ul class="nav nav-tabs nav-justified widget-tabbed__nav" role="tablist">
                        <li role="presentation" class="active"><a href="#widget-tabbed-newest"
                                                                  aria-controls="widget-tabbed-newest" role="tab"
                                                                  data-toggle="tab">Newest</a></li>
                        <li role="presentation"><a href="#widget-tabbed-commented"
                                                   aria-controls="widget-tabbed-commented" role="tab" data-toggle="tab">Most
                                Commented</a></li>
                        <li role="presentation"><a href="#widget-tabbed-popular" aria-controls="widget-tabbed-popular"
                            ...
                            <ul class="posts posts--simple-list">
                                <li class="posts__item posts__item--category-1">
                                    <div class="posts__inner">
                                        ...
                                        <time datetime="2016-08-23" class="posts__date">August 23rd, 2016</time>
                                        <div class="posts__excerpt">
                                            Lorem ipsum dolor sit amet, consectetur adipisi ng elit, sed do eiusmod
                                ...
                                <li class="posts__item posts__item--category-1">
                                    <div class="posts__inner">
                                        ...
                                        <h6 class="posts__title"><a href="#">The Alchemists news coach is bringin a new
                                                shooting guard</a></h6>
                                        <time datetime="2016-08-23" class="posts__date">August 23rd, 2016</time>
                                        <div class="posts__excerpt">
                                            Lorem ipsum dolor sit amet, consectetur adipisi ng elit, sed do eiusmod
                                ...
                                <li class="posts__item posts__item--category-1">
                                    <div class="posts__inner">
                                        ...
                                        <h6 class="posts__title"><a href="#">This Saturday starts the intensive training
                                                for the Final</a></h6>
                                        <time datetime="2016-08-23" class="posts__date">August 23rd, 2016</time>
                                        <div class="posts__excerpt">
                                            Lorem ipsum dolor sit amet, consectetur adipisi ng elit, sed do eiusmod
                                ...
                                <li class="posts__item posts__item--category-3">
                                    <div class="posts__inner">
                                        ...
                                        <h6 class="posts__title"><a href="#">New York Islanders are now flying to
                                                California for the big game</a></h6>
                                        <time datetime="2016-08-23" class="posts__date">August 23rd, 2016</time>
                                        <div class="posts__excerpt">
                                            Lorem ipsum dolor sit amet, consectetur adipisi ng elit, sed do eiusmod
                                            tempor incididunt ut labore et dolore magna aliqua.
                                ...
                                <li class="posts__item posts__item--category-1">
                                    <div class="posts__inner">
                                        ...
                                        <h6 class="posts__title"><a href="#">The Female Division is growing strong after
                                                their third game</a></h6>
                                        <time datetime="2016-08-23" class="posts__date">August 23rd, 2016</time>
                                        <div class="posts__excerpt">
                                            Lorem ipsum dolor sit amet, consectetur adipisi ng elit, sed do eiusmod
                                            tempor incididunt ut labore et dolore magna aliqua.
        ...
        <aside class="widget card widget--sidebar widget-banner">
            ...
            <div class="widget__content card__content">
                <figure class="widget-banner__img">
                    <a href="https://themeforest.net/item/the-alchemists-sports-news-html-template/19106722?ref=dan_fisher"><img
                                src="assets/images/samples/banner.jpg" alt="Banner"></a>
                </figure>
            </div>
        </aside>
        <!-- Widget: Banner / End -->
        ...
        <aside class="widget widget--sidebar card widget-newsletter">
            ...
            <div class="widget__content card__content">
                ...
                <div class="widget-newsletter__desc">
                    <p>Receive the latest news from the team: game reminders, new adquisitions and professional match
                        results.</p>
                </div>
